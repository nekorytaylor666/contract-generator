...
// Шаги модалки — по макету «Скачивание документа»: выбор формата, экран
...
/**
 * Модалка «Скачать документ» (по макету): выбор формата PDF/DocX, стоимость и
...
export function TemplateDownloadDialog({
  ...
  // «Скачать документ» выбран на экране лимита — шаг формата показывается в
  ...
  // апгрейда, и «Скачать документ» — из разовой покупки.
  ...
  // Последний успешно собранный файл: кнопка «Скачать документ» на экране
  ...
  // файл (экран успеха: «Документ скачивается автоматически»). Эффект должен
