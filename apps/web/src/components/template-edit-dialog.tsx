...
// Шаги модалки «Редактирование документа»: сводка стоимости, экран исчерпанного
// лимита с выбором «разовая покупка / повысить тариф», выбор нового тарифа,
// платёжные статусы Робокассы и создание копии документа
...
// Заголовок модалки: сводка — «Редактирование документа», попап тарифов —
...
/**
 * Модалка «Редактирование документа» (по макету): сводка стоимости с экономией
 ...
 * копию документа и ведёт в конструктор.
 */
export function TemplateEditDialog({
  ...
  // документах») на экране «Подготавливаем документ…», затем показываем
  // «Документ готов к редактированию» с переходом в конструктор.
